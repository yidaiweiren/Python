...
if __name__ == '__main__':
    res = downloader('http://www.zd9999.com/mf/index.htm')
    for i in range(2,55):
        res += downloader(f'http://www.zd9999.com/mf/index_{i}.htm')
    print(len(res))
    with open('yaofang.json', mode='w+', encoding='utf-8') as json_file:
