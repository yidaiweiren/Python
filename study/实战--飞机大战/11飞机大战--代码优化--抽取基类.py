...
class HeroPlane(BasePlane):
    ...
    def __init__(self,screen_temp):
        BasePlane.__init__(self,screen_temp,180,700,"./feiji/hero1.png")    #或者spuer().__init__(),这种可以不写self
...
class Bullet(BaseBullet):   #bullet：释义为“子弹”
    '''创建子弹类'''
    def __init__(self,screen_temp,x,y):
        BaseBullet.__init__(self,screen_temp,x+40,y-18,"./feiji/i1.png")
...
class EnemyBullet(BaseBullet):   #bullet：释义为“子弹”
    '''创建敌机子弹类'''
    def __init__(self,screen_temp,x,y):
        BaseBullet.__init__(self,screen_temp,x+22,y+40,"./feiji/bullet1.png")
